...
import { isAdmin, isNotAdmin } from '../middleware/auth';
...
router.patch('/:id(\\d+)/location', isNotAdmin, validateLocation, controller.updateLocation);
router.patch('/:id(\\d+)/comment', isNotAdmin, validateComment, controller.updateComment);
